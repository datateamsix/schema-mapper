...
### Changed
- **Documentation**: Redesigned README.md for professional, emoji-free layout
  - Removed all emojis for cleaner presentation on PyPI and GitHub
  - Updated project description to highlight ML feature engineering and data profiling capabilities
  - Reorganized content with better headings and structure
  - Added prominent ML & Data Science sections and examples
  - Improved Quick Start with ML Feature Engineering Workflow
  - Added complete ML use case: churn prediction with feature engineering
